...
namespace MainScreen.CustomControls
{
    ...
    public class CustomSlider : Control
    {
        ...
        /// </summary>
        /// <value>A <see cref="BorderStyle"/> that represents the border type of the trackbar control. 
        /// The default is <b>BorderStyle.None</b>.</value>
        ...
        #region Private LESSPAIN Properties
        ...
        private Size FitSize
        {
            get
            {
                ...
                Rectangle workingRect = Rectangle.Inflate(this.ClientRectangle, -indentWidth, -indentHeight);
                ...
                if (orientation == Orientation.Horizontal)
                {
                    ...
                    textAreaSize = g.MeasureString(maximum.ToString(), this.Font).Height;
                ...
                else //orientation == Orientation.Vertical
                {
                    ...
                    textAreaSize = g.MeasureString(maximum.ToString(), this.Font).Width;
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (orientation == Orientation.Horizontal)
            {
                ...
                // Get Height of Text Area
                textAreaSize = e.Graphics.MeasureString(maximum.ToString(), this.Font).Height;
                ...
                if (textTickStyle == TickStyle.TopLeft || textTickStyle == TickStyle.Both)
                {
                    ...
                    DrawTickTextLine(e.Graphics, drawRect, tickFrequency, minimum, maximum, this.ForeColor, this.Font, orientation);
                    //==========================================================================
                }
            ...
            else //orientation == Orientation.Vertical
            {
                ...
                // Get Width of Text Area
                textAreaSize = e.Graphics.MeasureString(maximum.ToString(), this.Font).Width;
        ...
        {
            DrawStyleHelper.DrawAquaPillSingleLayer(g, drawRect, trackLineColor, orientation);
        }
        ...
        {
            DrawStyleHelper.DrawAquaPill(g, trackerRect, trackerColor, orientation);
        }
        ...
        private void DrawBorder(Graphics g)
        {
            ...
            switch (borderStyle)
            {
                case BorderStyle.Dashed: //from ButtonBorderStyle Enumeration
                    ControlPaint.DrawBorder(g, this.ClientRectangle, borderColor, ButtonBorderStyle.Dashed);
                    break;
                case BorderStyle.Dotted: //from ButtonBorderStyle Enumeration
                    ControlPaint.DrawBorder(g, this.ClientRectangle, borderColor, ButtonBorderStyle.Dotted);
                    break;
                case BorderStyle.Inset: //from ButtonBorderStyle Enumeration
                    ControlPaint.DrawBorder(g, this.ClientRectangle, borderColor, ButtonBorderStyle.Inset);
                    break;
                case BorderStyle.Outset: //from ButtonBorderStyle Enumeration
                    ControlPaint.DrawBorder(g, this.ClientRectangle, borderColor, ButtonBorderStyle.Outset);
                    break;
                case BorderStyle.Solid: //from ButtonBorderStyle Enumeration
                    ControlPaint.DrawBorder(g, this.ClientRectangle, borderColor, ButtonBorderStyle.Solid);
                    break;

                case BorderStyle.Adjust: //from Border3DStyle Enumeration
                    ControlPaint.DrawBorder3D(g, this.ClientRectangle, Border3DStyle.Adjust);
                    break;
                case BorderStyle.Bump: //from Border3DStyle Enumeration
                    ControlPaint.DrawBorder3D(g, this.ClientRectangle, Border3DStyle.Bump);
                    break;
                case BorderStyle.Etched: //from Border3DStyle Enumeration
                    ControlPaint.DrawBorder3D(g, this.ClientRectangle, Border3DStyle.Etched);
                    break;
                case BorderStyle.Flat: //from Border3DStyle Enumeration
                    ControlPaint.DrawBorder3D(g, this.ClientRectangle, Border3DStyle.Flat);
                    break;
                case BorderStyle.Raised: //from Border3DStyle Enumeration
                    ControlPaint.DrawBorder3D(g, this.ClientRectangle, Border3DStyle.Raised);
                    break;
                case BorderStyle.RaisedInner: //from Border3DStyle Enumeration
                    ControlPaint.DrawBorder3D(g, this.ClientRectangle, Border3DStyle.RaisedInner);
                    break;
                case BorderStyle.RaisedOuter: //from Border3DStyle Enumeration
                    ControlPaint.DrawBorder3D(g, this.ClientRectangle, Border3DStyle.RaisedOuter);
                    break;
                case BorderStyle.Sunken: //from Border3DStyle Enumeration
                    ControlPaint.DrawBorder3D(g, this.ClientRectangle, Border3DStyle.Sunken);
                    break;
                case BorderStyle.SunkenInner: //from Border3DStyle Enumeration
                    ControlPaint.DrawBorder3D(g, this.ClientRectangle, Border3DStyle.SunkenInner);
                    break;
                case BorderStyle.SunkenOuter: //from Border3DStyle Enumeration
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            /// <summary>
            /// Specified WMKEYDOWN enumeration value.
            /// </summary>
            const int WMKEYDOWN = 0x0100;

            /// <summary>
            /// Specified WMSYSKEYDOWN enumeration value.
            /// </summary>
            ...
            if ((msg.Msg == WMKEYDOWN) || (msg.Msg == WMSYSKEYDOWN))
            {
                switch (keyData)
                {
                    case Keys.Left:
                    case Keys.Down:
                        this.Decrement(smallChange);
                        break;
                    case Keys.Right:
                    case Keys.Up:
                        this.Increment(smallChange);
                        break;

                    case Keys.PageUp:
                        this.Increment(largeChange);
                        break;
                    case Keys.PageDown:
                        this.Decrement(largeChange);
                        break;
        ...
        private void OnMouseDownSlider(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    case Orientation.Horizontal:
                        if (currentPoint.X + trackerSize.Width / 2 >= this.Width - indentWidth)
                            offsetValue = maximum - minimum;
                        else if (currentPoint.X - trackerSize.Width / 2 <= indentWidth)
                            offsetValue = 0;
                        else
                            offsetValue = (int)(((currentPoint.X - indentWidth - trackerSize.Width / 2) * (maximum - minimum)) / (this.Width - 2 * indentWidth - trackerSize.Width) + 0.5);

                        break;

                    case Orientation.Vertical:
                        if (currentPoint.Y + trackerSize.Width / 2 >= this.Height - indentHeight)
                            offsetValue = 0;
                        else if (currentPoint.Y - trackerSize.Width / 2 <= indentHeight)
                            offsetValue = maximum - minimum;
                        else
                            offsetValue = (int)(((this.Height - currentPoint.Y - indentHeight - trackerSize.Width / 2) * (maximum - minimum)) / (this.Height - 2 * indentHeight - trackerSize.Width) + 0.5);
        ...
        private void OnMouseMoveSlider(object sender, MouseEventArgs e)
        {
            ...
            if (leftButtonDown)
            {
                try
                {
                    ...
                    {
                        case Orientation.Horizontal:
                            if ((currentPoint.X + trackerSize.Width - mouseStartPos) >= this.Width - indentWidth)
                                offsetValue = maximum - minimum;
                            else if (currentPoint.X - mouseStartPos <= indentWidth)
                                offsetValue = 0;
                            else
                                offsetValue = (int)(((currentPoint.X - mouseStartPos - indentWidth) * (maximum - minimum)) / (this.Width - 2 * indentWidth - trackerSize.Width) + 0.5);
                        ...
                        case Orientation.Vertical:
                            if (currentPoint.Y + trackerSize.Width / 2 >= this.Height - indentHeight)
                                ...
                                offsetValue = (int)(((this.Height - currentPoint.Y + trackerSize.Width / 2 - mouseStartPos - indentHeight) * (maximum - minimum)) / (this.Height - 2 * indentHeight) + 0.5);
